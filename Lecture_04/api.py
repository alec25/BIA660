...
driver = webdriver.Firefox(executable_path='./geckodriver')#executable_path='./geckodriver'

#driver.get('http://www.nytimes.com') #stop doing this
...
#emojis: monkey_face, custard
#https://unicodey.com/emoji-data/table.htm
payload = {'username': 'generic_bot_username',
           'icon_emoji': ':custard:',
           'text': "<https://unicodey.com/emoji-data/table.htm|List of Slack-supported emoji names>"
           }

SLACK_URL = 'https://hooks.slack.com/services/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' #careful
